          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 1 }}>
                ...
                {/* Waze deep link — web only */}
                {!isTeslaBrowser && (
                  <a
                    href={buildWazeDeepLink({ lat: destination.lat, lon: destination.lng, navigate: true, query: destination.name })}
                    target="_blank"
