...
export const VEHICLE_CONFIGS: ModelConfig[] = [
  ...
  },
  {
    ...
    trims: [
      // ── 2012–2016 era ───────────────────────────────────────────
      { id: 'S60',       label: '60 RWD',          usableKwh: 58,  efficiencyWhKm: 200, yearRange: [2012, 2016] },
      { id: 'S70D',      label: '70 AWD',          usableKwh: 65,  efficiencyWhKm: 175, yearRange: [2012, 2016] },
      { id: 'S85',       label: '85 RWD',          usableKwh: 74,  efficiencyWhKm: 180, yearRange: [2012, 2016] },
      { id: 'S85D',      label: '85 AWD',          usableKwh: 74,  efficiencyWhKm: 172, yearRange: [2012, 2016] },
      // ── 2016–2019 era ───────────────────────────────────────────
      { id: 'S75',       label: '75 RWD',          usableKwh: 72,  efficiencyWhKm: 185, yearRange: [2016, 2019] },
      { id: 'S75D',      label: '75 AWD',          usableKwh: 72,  efficiencyWhKm: 178, yearRange: [2016, 2019] },
      { id: 'S90D',      label: '90 AWD',          usableKwh: 81,  efficiencyWhKm: 170, yearRange: [2016, 2019] },
      { id: 'S100D',     label: '100 AWD',         usableKwh: 93,  efficiencyWhKm: 168, yearRange: [2016, 2019] },
      // ── 2019–2021 era ───────────────────────────────────────────
      { id: 'LR_AWD_19', label: 'Long Range AWD',  usableKwh: 95,  efficiencyWhKm: 172, yearRange: [2019, 2021] },
      // ── 2021+ era ───────────────────────────────────────────────
      { id: 'LR_AWD',    label: 'Long Range AWD',  usableKwh: 95,  efficiencyWhKm: 175, yearRange: [2021, 2025] },
      { id: 'PLAID',     label: 'Plaid',           usableKwh: 95,  efficiencyWhKm: 192, yearRange: [2021, 2025] },
      // ── Legacy IDs — kept for backward-compat of saved profiles ─
      { id: 'P85',       label: '85 AWD',          usableKwh: 74,  efficiencyWhKm: 185, yearRange: [2012, 2016] },
      { id: 'P85D',      label: '85 AWD',          usableKwh: 74,  efficiencyWhKm: 183, yearRange: [2012, 2016] },
      { id: 'P90D',      label: '90 AWD',          usableKwh: 81,  efficiencyWhKm: 183, yearRange: [2016, 2019] },
      { id: 'P100D',     label: '100 AWD',         usableKwh: 93,  efficiencyWhKm: 180, yearRange: [2016, 2019] },
      { id: 'LR',        label: 'Long Range',      usableKwh: 95,  efficiencyWhKm: 172, yearRange: [2019, 2021] },
    ],
  },
  {
    model: 'Model X',
