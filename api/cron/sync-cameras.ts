...
const REGIONS: Record<string, { bbox: BBox; redisCountry: string }> = {
  ...
  'NO-1b': { bbox: { minLat: 58.4,   minLng: 4.479,  maxLat: 58.8,   maxLng: 31.293 }, redisCountry: 'NO' },
  ...
  'NO-4a': { bbox: { minLat: 60.0,   minLng: 4.479,  maxLat: 60.3,   maxLng: 31.293 }, redisCountry: 'NO' },
  ...
  'NO-5b': { bbox: { minLat: 60.95,  minLng: 4.479,  maxLat: 61.3,   maxLng: 31.293 }, redisCountry: 'NO' },
